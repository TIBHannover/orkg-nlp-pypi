...
class TestResearchFieldClassifier(TestCase):
    def setUp(self):
        ...
        self.raw_input = """Understanding of cybersecurity threat landscape especially information about threat
    ...
    def test_classify(self):
        top_n = 6
        labels = self.classifier(raw_input=self.raw_input, top_n=top_n)
